...
function setSafeTimers() {
	const { setTimeout: safeSetTimeout, setInterval: safeSetInterval, clearInterval: safeClearInterval, clearTimeout: safeClearTimeout, setImmediate: safeSetImmediate, clearImmediate: safeClearImmediate, queuee.formula;if(c.reason.kind===i.ReasonKind.JavaScriptError)throw c.reason.error}catch(e){const t="calc.lang.anonymizeFormula: Format failed: "+(0,i.messageFromError)(e);i.ulsLogger.ULS.traceTag(507381981,o.LogCategory.msoulscat_ES_EWAJS,o.TraceLevel.Warning,t)}return(0,i.anonymize)(t)},t.createPrinter=function(e){const t=function(e){return{config:e.config,getDocumentLoc:e.getDocumentLoc.bind(e),getSheetIndex:e.getSheetIndex.bind(e),getSheetName:e.getSheetName.bind(e),getNameLoc:e.getNameLoc.bind(e),getUserDefinedFuncLoc:e.getUserDefinedFuncLoc.bind(e),getSheetRangeIndexes:e.getShe