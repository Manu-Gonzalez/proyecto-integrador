 ...
 * ] as const
 *
 * //      â”Œâ”€â”€â”€ Effect<[number, string], never, never>
 * //      â–¼
 ...
 * )
 *
 * //      â”Œâ”€â”€â”€ Effect<number[], never, never>
 * //      â–¼
 ...
 * }
 *
 * //      â”Œâ”€â”€â”€ Effect<{ a: number; b: string; }, never, never>
 * //      â–¼
 ...
 * }
 *
 * //      â”Œâ”€â”€â”€ Effect<{ [x: string]: number; }, never, never>
 * //      â–¼
 ...
 * import { Effect } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<[string[], number[]], never, never>
 * //      â–¼
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<number[], [string, ...string[]], never>
 * //      â–¼
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<number, string[], never>
 * //      â–¼
 ...
 *   })
 *
 * //      â”Œâ”€â”€â”€ Effect<Buffer, Error, never>
 * //      â–¼
 ...
 * import { Effect } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<never, Error, never>
 * //      â–¼
 ...
 *   )
 *
 * //      â”Œâ”€â”€â”€ Effect<string, never, never>
 * //      â–¼
 ...
 * }
 *
 * //      â”Œâ”€â”€â”€ Effect<string, HttpError | ValidationError, never>
 * //      â–¼
 * const program = Effect.gen(function* () {
 ...
 * })
 *
 * //      â”Œâ”€â”€â”€ Effect<string, ValidationError, never>
 * //      â–¼
 * const recovered = program.pipe(
 *   Effect.catchIf(
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<string, Error, never>
 * //      â–¼
 * const task = Effect.fail(new Error("Oh uh!")).pipe(
 *   Effect.as("primary result")
 * )
 *
 * //      â”Œâ”€â”€â”€ Effect<string, Cause<Error>, never>
 * //      â–¼
 ...
 *
 * //      â”Œâ”€â”€â”€ Effect<any, UnknownException, never>
 * //      â–¼
 * const program = parse("")
 *
 * ```
 ...
 *   })
 *
 * //      â”Œâ”€â”€â”€ Effect<any, Error, never>
 * //      â–¼
 * const program = parse("")
 * ```
 *
 ...
 *   )
 *
 * //      â”Œâ”€â”€â”€ Effect<Response, UnknownException, never>
 * //      â–¼
 ...
 *   })
 *
 * //      â”Œâ”€â”€â”€ Effect<Response, Error, never>
 * //      â–¼
 * const program = getTodo(1)
 * ```
 *
 ...
 * const program = Effect.fail("Oh uh!").pipe(Effect.as(2))
 *
 * //      â”Œâ”€â”€â”€ Effect<string, number, never>
 * //      â–¼
 ...
 *
 * //      â”Œâ”€â”€â”€ Effect<boolean, Error, never>
 * //      â–¼
 ...
 * const simulatedTask = Effect.fail("Oh no!").pipe(Effect.as(1))
 *
 * //      â”Œâ”€â”€â”€ Effect<number, Error, never>
 * //      â–¼
 ...
 * //
 * //      â”Œâ”€â”€â”€ Effect<MyResource, Error, Scope>
 * //      â–¼
 ...
 *
 * //      â”Œâ”€â”€â”€ Effect<void, Error, never>
 * //      â–¼
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<string, never, Scope>
 * //      â–¼
 * const program = Effect.gen(function* () {
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<never, string, Scope>
 * //      â–¼
 * const program = Effect.gen(function* () {
 *   yield* Effect.addFinalizer((exit) =>
 *     Console.log(`Finalizer executed. Exit status: ${exit._tag}`)
 ...
 * // Wrapping the effect in a scope
 * //
 * //      â”Œâ”€â”€â”€ Effect<never, string, never>
 * //      â–¼
 * const runnable = Effect.scoped(program)
 *
 * Effect.runPromiseExit(runnable).then(console.log)
 ...
 * import { Effect, Console } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<never, never, Scope>
 * //      â–¼
 * const program = Effect.gen(function* () {
 *   yield* Effect.addFinalizer((exit) =>
 *     Console.log(`Finalizer executed. Exit status: ${exit._tag}`)
 ...
 * // Wrapping the effect in a scope
 * //
 * //      â”Œâ”€â”€â”€ Effect<never, never, never>
 * //      â–¼
 * const runnable = Effect.scoped(program)
 *
 * Effect.runPromiseExit(runnable).then(console.log)
 ...
 *
 * **Example** (Running a Cleanup Function with the Effectâ€™s Result)
 *
 * ```ts
 ...
 *
 * //      â”Œâ”€â”€â”€ Effect<RuntimeFiber<number, never>, never, never>
 * //      â–¼
 ...
 *
 * Fibers created with this function are isolated from the parent fiberâ€™s
 ...
 * )
 *
 * //      â”Œâ”€â”€â”€ Effect<void, never, Scope>
 * //      â–¼
 * const parent = Effect.gen(function* () {
 *   console.log("parent: started!")
 ...
 * })
 *
 * //      â”Œâ”€â”€â”€ Effect<string, never, Service2>
 * //      â–¼
 ...
 * )
 *
 * //      â”Œâ”€â”€â”€ Effect<unknown[], never, Database>
 * //      â–¼
 * const program = Effect.gen(function*() {
 ...
 * })
 *
 * //      â”Œâ”€â”€â”€ Effect<unknown[], never, never>
 * //      â–¼
 ...
 * //      â–¼
 * const recovered = Effect.gen(function* () {
 *   //      â”Œâ”€â”€â”€ Either<string, HttpError | ValidationError>
 *   //      â–¼
 ...
 *
 * The `Effect.raceFirst` function safely interrupts the â€œloserâ€ effect once the other completes, but it will not resume until the loser is cleanly terminated.
 *
 ...
 * **Details**
 *
 * This function runs two effects concurrently and calls a specified â€œfinisherâ€
 ...
 * )
 *
 * //      â”Œâ”€â”€â”€ RuntimeFiber<number, never>
 * //      â–¼
 ...
 * import { Effect } from "effect"
 *
 * //      â”Œâ”€â”€â”€ Effect<number, NoSuchElementException, never>
 * //      â–¼
 ...
 * Itâ€™s ideal for scenarios where you want to explicitly represent optionality
 ...
