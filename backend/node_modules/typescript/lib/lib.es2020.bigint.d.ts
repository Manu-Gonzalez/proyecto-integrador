...
interface BigIntToLocaleStringOptions {
    ...
    /**
     * The currency to use in currency formatting. Possible values are the ISO 4217 currency codes, such as "USD" for the US dollar, "EUR" for the euro, or "CNY" for the Chinese RMB ‚Äî see the Current currency & funds code list. There is no default value; if the style is "currency", the currency property must be provided. It is only used when [[Style]] has the value "currency".
     */
    currency?: string;
     ...
     *
     * "symbol" to use a localized currency symbol such as ‚Ç¨,
     *
...
interface DataView<TArrayBuffer extends ArrayBufferLike> {
    ...
    /**
     * Gets the Bi¢    ê?       ˇˇˇ»è?»ê?pë?¯ˇˇˇ8í?¯ˇˇˇí?hbin ê?                       XˇˇˇC : \ P r o g r a m   F i l e s \ S o l i d W o r k s   C o r p \ S o l i d W o r k s   F l o w   S i m u l a t i o n \ b i n C F W \ F W c o n t r o l . d l l     ÿˇˇˇvk z   ê?      InprocServer32  ÄˇˇˇC } a ~ @ W ' @ p ? + D E o O C P I w = C F W i N T S e l f R e g F i l e s > ' L V 9 W O q b k 8 1 K ' O ? d R l l r       ÿˇˇˇvk    òë?      ThreadingModel  ËˇˇˇA p a r t m e n t   –ˇˇˇlh hè?C«⁄‡ë?uıTêí?’óRì?◊ßÿì?sQ®ˇˇˇnk  9ò|_⁄   †é?        ˇˇˇˇˇˇˇˇ   è? Äê ˇˇˇˇ  †         6          ProgID  Ëˇˇˇvk  6   Pí?       ¿ˇˇˇF W C o n t r o l s . F W C o n t r o l s R u n . 1         †ˇˇˇnk  ÷}Ò|_⁄   †é?        ˇˇˇˇˇˇˇˇ   ¯è? Äê ˇˇˇˇ  †                   Programmable    Ëˇˇˇvk    Ä           ®ˇˇˇnk  ÷}Ò|_⁄   †é?        ˇˇˇˇˇˇˇˇ   –ì? Äê ˇˇˇˇ  †         N          TypeLib Ëˇˇˇvk  N   xì?     T®ˇˇˇ{ 3 5 6 4 0 3 5 2 - F 2 F 5 - 4 E 3 D - A 1 B 8 - 3 8 F F 5 3 4 0 B 9 2 0 }         ¯ˇˇˇ`ì?òˇˇˇnk  9ò|_⁄   †é?        ˇˇˇˇˇˇˇˇ   êî? Äê ˇˇˇˇ  †         2          VersionIndependentProgIDËˇˇˇvk  2   Xî?     T»ˇˇˇF W C o n t r o l s . F W C o n t r o l s R u n     ¯ˇˇˇ@î?àˇˇˇnk  yÒUÒﬁ¨’   @^         Hñ?ˇˇˇˇ   8ï?∏  ˇˇˇˇ                  &   {8135397C-5C6C-4f