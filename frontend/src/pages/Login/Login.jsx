...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Trigger storage event to update nav
    ...
    return (
        <div className='d-flex mobile-flex-col login-container'>
            <div className="d-flex justify-center align-center vh100 mobile-w-full login-left">
                <Card className="form-container d-flex flex-col gap-5 mobile-gap-3 login-form">
                    <h1 className="text-center mb-4 mobile-text-center"><b>INICIAR SESION</b></h1>
                    <h5 className="mobile-text-center">INICIA SESION ASI PODES REALIZAR PEDIDOS</h5>
                    ...
                    <div className="text-center mt-3">
                        <p>¿No tienes cuenta? <a href="/register" className="primary-link">Registrarme</a></p>
                    </div>
                </Card>
                <svg 
                    width="433" 
                    ...
                    className="mobile-hidden login-svg"
                >
            ...
            <div className="mobile-hidden login-right">
